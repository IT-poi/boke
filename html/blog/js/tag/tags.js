...
(function ($) {
    ...
    Tags.prototype = {
        ...
        bind: function (elem) {
            ...
            elem.keypress(function (event) {
                ...
                var oldValue = self.parent().children('[data-toggle="tags"]').val();
                var valueArray = oldValue ? oldValue.split(',') : [];
    ...
    $.fn.tags = function (tagValues) {
        var tags = new Tags(this),
            values = isBlank(tagValues) ? [] : tagValues.split(','),
