...
//		String string = "太多的伤感情怀也许只局限于饲养基地 荧幕中的情节，少妇主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
...
//		String s = filter.replaceSensitiveWord(string, maxMatchType, "*");
//		System.out.println("替换之后的语句：" + s);
