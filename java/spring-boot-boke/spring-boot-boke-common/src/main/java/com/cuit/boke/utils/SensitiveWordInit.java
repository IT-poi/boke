...
public class SensitiveWordInit {
	...
	private static final String path = "/opt/springcloud/senstive";
	...
	private Set<String> readSensitiveWordFile() throws BizException {
		...
		if (dir.isDirectory()) {
			...
			for (File file : files) {
				try (InputStreamReader read = new InputStreamReader(new FileInputStream(file), ENCODING);
					...
					throw new BizException("初始化失败，读取敏感词库异常！");
				}
			}
		}
		return set;
